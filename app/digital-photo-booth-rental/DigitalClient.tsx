        ...
        <div className="container mx-auto px-6 max-w-6xl">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <motion.div initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.8, delay: 0.15 }} className="grid grid-cols-2 gap-4">
              {[{ val: "Karachi", label: "Available for all events", icon: "🏙️", href: "/karachi-photo-booth-rental" }, { val: "Lahore", label: "Pakistan's party capital", icon: "✨", href: "/lahore-photo-booth-rental" }, { val: "Islamabad", label: "Corporate & private events", icon: "🏢", href: "/islamabad-photo-booth-rental" }, { val: "Multan", label: "Now available!", icon: "🎉", href: "/photo-booth-rental-multan" }].map(s => (
