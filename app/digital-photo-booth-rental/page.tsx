...
export const metadata: Metadata = {
  ...
  description: "Our Digital Photo Booth Rental offers instant digital photos, GIFs, and videos with instant social sharing. Perfect for any modern event.",
};

const features = [
  "Instant GIF & boomerang creation",
  "Digital delivery via text & email",
  "No physical prints needed — fully digital",
  "Custom branded overlays & filters",
  "Real-time social sharing & hashtag wall",
  "Works for indoor & outdoor events",
];
      ...
      <section className="py-20 md:py-28">
        <div className="container mx-auto px-6 max-w-6xl">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              <h2 className="text-3xl md:text-4xl font-extrabold mb-6 tracking-tight">Go Fully Digital. Zero Waste.</h2>
              <p className="text-white/60 text-base leading-relaxed mb-10">
                Our Digital Photo Booth is the future of event photography. Guests take photos, GIFs, and boomerangs which are instantly delivered via text or email. No printing delays — just instant digital memories that guests can share immediately on social media.
              </p>
            ...
            <div className="relative aspect-[4/5] rounded-[2rem] overflow-hidden">
              <Image
                src="https://images.unsplash.com/photo-1530105832477-df30d324b8e2?q=80&w=800&auto=format&fit=crop"
                alt="Digital Booth at Event"
                fill
