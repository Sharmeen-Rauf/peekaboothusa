...
export default function OpenAirPage() {
  return (
    <main className="min-h-screen bg-black text-white">
      ...
      {/* ΓöÇΓöÇ ABOUT / CLASSIC FUN ΓöÇΓöÇ */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
            ...
            <div>
              ...
              <p className="text-white/60 text-sm leading-relaxed mb-8">
                An Open Air Photo Booth is a freestanding photo station — without an enclosed cabinet — that uses a professional-grade camera, studio lighting, and a custom backdrop to capture stunning photos of your guests. Unlike traditional enclosed booths, the open air design is spacious enough for large groups and feels more like a professional photoshoot. Our open air photo booth rental in Pakistan comes fully equipped with everything your event needs: custom backdrops, fun props, branded print templates, and a professional attendant.
              </p>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {["Instant Photo Prints", "Customizable Backdrops", "Fun Party Props", "Friendly Attendant", "Unlimited Sessions", "Digital Gallery"].map((f) => (
      ...
      <section id="pricing" className="py-16 md:py-20 bg-[#050505] border-y border-white/5">
        <div className="container mx-auto px-6 max-w-6xl">
          <div className="text-center mb-12">
            <p className="text-brand-neon text-xs font-bold tracking-[0.3em] uppercase mb-3">All Inclusive Packages</p>
            <h2 className="text-2xl md:text-3xl font-extrabold tracking-tight mb-3">Open Air Photo Booth Rental Pricing</h2>
            <p className="text-white/50 text-sm max-w-2xl mx-auto leading-relaxed">
              Peek-A-Booth's open air photo booths come packed with features like instant printing, customizable templates, professional lighting, and fun props. Choose the package that fits your event.
            </p>
          </div>
      ...
      {/* ΓöÇΓöÇ NEED MORE HOURS BANNER ΓöÇΓöÇ */}
      ...
      {/* ΓöÇΓöÇ RESERVE YOUR DATE ΓöÇΓöÇ */}
        ...
        <div className="container mx-auto px-6 max-w-6xl">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-white/60 text-sm leading-relaxed mb-8">
                Choose Peek-A-Booth for open air photo booth rentals, exceptional service, and nationwide coverage in Karachi, Lahore, Islamabad, and Multan. With customizable backdrops, unlimited prints, and fun props, our booths create unforgettable memories for any event!
              </p>
