...
const customTestimonials: TestimonialItem[] = [
  {
    id: 1,
    name: "Farrukh K.",
    avatar: "https://i.pravatar.cc/150?u=farrukh",
    text: "Absolute party essential! We hired the photo booth for our Eid party and it was the best decision. Everyone was using it all night ΓÇö kids, adults, everyone! The Peek-A-Booth team was super professional."
  }
];
      ...
      <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden pt-20">
        ...
        <div className="container mx-auto px-6 max-w-4xl relative z-20 text-center pt-10 pb-20">
          ...
          <motion.p initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 1, delay: 0.7 }} className="text-base md:text-lg text-white/80 mb-10 max-w-2xl mx-auto font-light leading-relaxed">
            Looking to make your next party truly memorable? Peek-A-Booth PK's party photo booth rental service brings instant entertainment, fun props, and beautiful photo memories to any type of gathering in Pakistan.
          </motion.p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            <motion.div initial={{ opacity: 0, x: -40 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.8 }}>
              ...
              <h2 className="text-4xl md:text-5xl lg:text-6xl font-extrabold tracking-tight mb-6 leading-[1.1]">
                The Life of <span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-neon to-brand-glow">Every Party</span>
              </h2>
              <div className="w-20 h-1 bg-brand-neon rounded-full mb-8" />
              <p className="text-white/70 text-base md:text-lg leading-relaxed mb-6">
                From Eid celebrations and farewell parties to baby showers and university events ΓÇö we're the party photo booth that keeps guests entertained all night long. Compact, portable, and perfect for any venue.
              </p>
            </motion.div>
