  ...
  return (
    <section ref={ref} className="relative min-h-[100vh] flex items-center justify-center overflow-hidden pt-20 pb-20">
      ...
      <motion.div className="relative z-20 text-center px-6 max-w-5xl mx-auto" style={{ opacity, y }}>
        ...
        >
          <p className="mb-4">Make your next event go viral! The 360 Photo Booth is the most exciting, shareable, and talked-about photo booth experience in Pakistan. A professional-grade rotating arm sweeps 360 degrees around your guests, capturing jaw-dropping slow-motion video from every angle ΓÇö creating cinematic, social-media-ready content in seconds.</p>
          <p>Whether it's a grand baraat, a corporate brand launch, a birthday celebration, or a VIP gala ΓÇö our 360 photo booth rental will be the centrepiece of your event. Guests line up for their turn, and the footage is instantly shared to their phones.</p>
        </motion.div>
      ...
      <div className="container mx-auto px-6 max-w-6xl">
        ...
        <div className="mt-16 text-center max-w-3xl mx-auto">
          <p className="text-white/60 text-sm leading-relaxed mb-8">
            The entire experience takes under 3 minutes ΓÇö and the results look absolutely incredible. Perfect for social media reels, Instagram stories, and TikTok content.
          </p>
      ...
      <div className="container mx-auto px-6 max-w-6xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="bg-[#0a0a0a] border border-white/10 hover:border-white/20 p-8 rounded-3xl transition-all">
            ...
            <p className="text-white/60 text-sm leading-relaxed">360 booth videos are incredibly shareable. Your guests will post their 360 videos on Instagram, TikTok, and WhatsApp immediately ΓÇö giving your event organic social media coverage that no other entertainment option can match.</p>
          </div>
          <div className="bg-[#0a0a0a] border border-white/10 hover:border-white/20 p-8 rounded-3xl transition-all">
            <Users className="w-8 h-8 text-brand-neon mb-4" />
            <h3 className="text-xl font-bold mb-3">Perfect for All Ages</h3>
            <p className="text-white/60 text-sm leading-relaxed">From kids to grandparents, everyone loves the 360 booth. It's interactive, easy to use, and the results are universally impressive. It's a crowd-pleaser at every event ΓÇö from intimate family gatherings to large-scale corporate events.</p>
          </div>
          <div className="bg-[#0a0a0a] border border-white/10 hover:border-white/20 p-8 rounded-3xl transition-all">
      ...
      <div className="container mx-auto px-6 max-w-6xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-[#0a0a0a] border border-white/10 hover:border-brand-neon/30 p-8 rounded-[2rem] flex flex-col transition-all group">
            ...
            <p className="text-white/60 text-sm leading-relaxed mb-6 flex-grow">Make your baraat, mehndi, or walima unforgettable. Pakistani weddings are grand celebrations, and the 360 booth adds that extra magic. Imagine a stunning slow-motion video of the bride and groom ΓÇö it's the ultimate wedding keepsake. Also known as the 360 booth wedding experience, our setup can accommodate multiple guests and creates breathtaking group videos.</p>
          ...
          <div className="bg-[#0a0a0a] border border-white/10 hover:border-brand-neon/30 p-8 rounded-[2rem] flex flex-col transition-all group">
            ...
            <p className="text-white/60 text-sm leading-relaxed mb-6 flex-grow">Whether it's a product launch, annual dinner, brand activation, or company milestone event ΓÇö the 360 booth drives maximum engagement. Branded overlays, custom templates, and instant social sharing make it the most powerful corporate entertainment tool available in Pakistan.</p>
          ...
          <div className="bg-[#0a0a0a] border border-white/10 hover:border-brand-neon/30 p-8 rounded-[2rem] flex flex-col transition-all group">
            ...
            <p className="text-white/60 text-sm leading-relaxed mb-6 flex-grow">Eid celebrations, university events, farewells, award ceremonies, and VIP gatherings ΓÇö our 360 camera booth rental brings high-energy fun to any occasion. It's the most talked-about addition to any event in Pakistan.</p>
    ...
    <section className="py-16 md:py-20 bg-[#050505] border-t border-white/5">
      <div className="container mx-auto px-6 max-w-6xl">
        <div className="bg-brand-neon/10 border border-brand-neon/30 rounded-[2.5rem] p-10 md:p-16 text-center">
          ...
          <h2 className="text-2xl md:text-4xl font-extrabold tracking-tight mb-6">360 Photo Booth Rental Near Me ΓÇö Serving Pakistan-Wide</h2>
          ...
          <div className="flex flex-wrap justify-center gap-4 mb-8">
            {[
              "Karachi ΓÇö Available for all events",
              "Lahore ΓÇö Pakistan's party capital",
              "Islamabad ΓÇö Corporate & private events",
              "Multan ΓÇö Now available!"
            ].map((city) => (
      ...
      <div className="container mx-auto px-6 max-w-4xl relative z-10 text-center">
        ...
        >
          ...
          <motion.p variants={fadeUp} className="text-white/70 text-base max-w-2xl mx-auto mb-8 leading-relaxed">
            ...
            <br /><br />
            Contact us today for a custom quote tailored to your event ΓÇö we'll work within your budget to deliver a premium 360 experience.
          </motion.p>
      ...
      <div className="container mx-auto px-6 max-w-6xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
          <div className="bg-[#0a0a0a] border border-white/10 p-10 rounded-[2.5rem]">
            ...
            <p className="text-brand-neon font-bold text-sm">ΓÇö Mariam K., Lahore</p>
          </div>
          <div className="bg-[#0a0a0a] border border-white/10 p-10 rounded-[2.5rem]">
            <div className="flex gap-1 mb-6">
              {[1, 2, 3, 4, 5].map((s) => <Star key={s} className="w-4 h-4 text-brand-neon fill-brand-neon" />)}
            ...
            <p className="text-brand-neon font-bold text-sm">ΓÇö Tariq M., Brand Manager, Karachi</p>
          </div>
        </div>
        <div className="flex justify-center">
          <Link
    ...
    <section className="py-16 md:py-20 bg-black border-t border-white/5">
      <div className="container mx-auto px-6 max-w-4xl">
        <div className="text-center mb-10">
          ...
          <h2 className="text-3xl md:text-5xl font-extrabold tracking-tight mb-3">Frequently Asked Questions ΓÇö 360 Photo Booth Rental</h2>
        </div>
