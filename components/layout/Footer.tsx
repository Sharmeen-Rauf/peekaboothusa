    ...
    <footer className="relative bg-background pt-24 pb-12 overflow-hidden border-t border-border">
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10 flex flex-col items-center">
        ...
        <div className="w-full max-w-6xl border border-border rounded-xl overflow-hidden flex flex-col lg:flex-row items-stretch justify-center bg-card mb-12 shadow-2xl">
          ...
          <Link href="/portal" className="flex items-center justify-center px-8 py-5 md:py-6 text-foreground/80 hover:text-brand-neon hover:bg-foreground/5 transition-colors border-b lg:border-b-0 lg:border-r border-border w-full lg:w-auto font-semibold whitespace-nowrap text-sm">
            Client Portal
          </Link>
          <Link href="/admin" className="flex items-center justify-center px-8 py-5 md:py-6 text-foreground/80 hover:text-brand-neon hover:bg-foreground/5 transition-colors border-b lg:border-b-0 lg:border-r border-border w-full lg:w-auto font-semibold whitespace-nowrap text-sm">
            Admin Panel
          </Link>
