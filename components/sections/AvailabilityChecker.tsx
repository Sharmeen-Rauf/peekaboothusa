    ...
    <section className="py-12 md:py-16 relative">
      <div className="container mx-auto px-4 md:px-6 relative z-10 max-w-6xl">
        <motion.div 
          ...
          viewport={{ once: true }}
          className="bg-card border border-border p-8 md:p-10 lg:p-14 rounded-[2rem] md:rounded-[3rem] relative overflow-hidden shadow-2xl"
        >
          ...
          <div className="relative z-10 flex flex-col lg:flex-row gap-10 lg:gap-12 items-center justify-between">
            ...
            <div className="w-full lg:w-1/3 flex flex-col items-center lg:items-start text-center lg:text-left">
              <h3 className="text-3xl md:text-4xl lg:text-5xl font-extrabold mb-3 tracking-tight text-foreground leading-[1.1]">
                Check<br className="hidden lg:block"/> Availability
              </h3>
              <p className="text-foreground/50 text-sm md:text-base max-w-[280px]">
            ...
            <div className="w-full lg:w-2/3 flex flex-col sm:flex-row gap-4 items-center justify-end">
              ...
              <div className="relative w-full sm:w-auto flex-1 max-w-[260px]">
                ...
                <input 
                  ...
                  className="w-full bg-surface border border-border hover:border-foreground/20 rounded-2xl py-4 pl-12 pr-4 text-foreground/80 placeholder-foreground/40 focus:outline-none focus:border-brand-neon/50 focus:ring-1 focus:ring-brand-neon/50 transition-all dark:[color-scheme:dark] light:[color-scheme:light] text-sm font-medium"
                />
              </div>
              ...
              <div className="relative w-full sm:w-auto flex-1 max-w-[260px]">
                ...
                <input 
                  ...
                  className="w-full bg-surface border border-border hover:border-foreground/20 rounded-2xl py-4 pl-12 pr-4 text-foreground/80 placeholder-foreground/40 focus:outline-none focus:border-brand-neon/50 focus:ring-1 focus:ring-brand-neon/50 transition-all text-sm font-medium"
                />
              </div>
