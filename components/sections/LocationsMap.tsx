      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10 max-w-5xl">
        ...
        >
          ...
          <div className="space-y-6 max-w-4xl mx-auto">
            <p className="text-white/90 font-medium text-sm md:text-base leading-relaxed tracking-wide drop-shadow-md">
            ...
            <p className="text-white/50 text-xs md:text-sm leading-relaxed max-w-3xl mx-auto font-medium">
